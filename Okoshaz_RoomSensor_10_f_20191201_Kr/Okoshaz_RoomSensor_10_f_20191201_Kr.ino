...
#define MY_RADIO_RF24 //!< RF24L01 radio driver
...
//#define LIGHT_INPUT_SENSOR A0   // The digital input you attached your motion sensor.  (Only 2 and 3 generates interrupt!)
